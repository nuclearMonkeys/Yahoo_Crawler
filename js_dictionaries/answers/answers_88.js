var answers_dict = {
	...
	4404 : ["A neon lamp is a special animal device. If you apply a DC voltage across it's terminals you can slowly increase the voltage until it reaches a flash point where it ignites into conduction. If you then decrease the voltage it will drop lower and lower unti", 742, "a8pRDaIyaa", 0],
	4405 : ["turn it off for a while, that will give it a rest.", 743, "8Y7LQ6TGaa", 0],
	4406 : ["Reset?  What is the model number?", 743, "None", 1],
	4407 : ["You calculate all the equivalent resistances first.  Then using the equivalent resistance with the voltage, calculate the total current.  So each parallel resistance group has the same series current.  Now you break down each parallel resistance group and", 744, "None", 1],
	...
	4410 : ["The Russian Federation, simply often called Russia, is the world's largest country by area. Although Russia lies in both Europe and Asia, i.e. Eurasia, by far the greater part is in Asia. Russia is the largest country in Asia. The largest country, by area", 735, "kz04oBhsaa", 0],
	...
	4415 : ["Various persons have set records by staying awake for 11 days or more.  The main effects, which are deficits in mental functioning, seem to disappear after weeks or even days of recovery.  A well-known record-setter reported that his only long-term proble", 737, "Kf4PiubQaa", -2],
	4416 : ["  you are aware he aint a Dr in the medical sense- he became a dr as a result of his PhD he is also the head of vaccine research  at DZIF (ie he has a vested interested in STOPPING use of current vaccines) AND he was program manager at GAVI which ALSO wor", 738, "rE6Kj640aa", 0],
	4417 : ["Put black tape over the sensor", 733, "AA12110242", 0],
	4418 : ["You could use a relay to turn on the LED. When power goes to the LED, that same power directly or indirectly goes to the relay coil to keep it on. Or you could use an SCR to turn on the LED as an SCR will stay on once triggered until the current through i", 733, "SDfL6IOPaa", 0],
	4419 : ["Three 21 ohm bulbs in series, connected to 12 volts?  That's 63 ohms load across 12 volts.  12/63 = .19 amps  So each bulb has .19 amps and 1/3 of the 12 volts, so 4 volts. 4 × .19 = .76 watts  Is this what you wanted to know?  I hope it's what you're ask", 745, "None", 1],
	...
	4431 : ["Yes, it makes sense. There is mantle plume of magma that the Pacific plate is moving over. There already is a new island Lohai still below sea level which is also rising as the glaciers melt. Continental drift is a scientific fact. The Canary Islands are ", 747, "x7kOP9CGaa", 0],
	...
	4438 : ["τ = RC = 36k x 3µ = 108 ms 77 = 110[1-e^(-t/0.108)] 1–e^(–t/0.108) = 77/110 = 0.7 e^(–t/0.108) = 0.3 –t/0.108 = ln 0.3 = -1.204 t = 0.130 sec f = 1/t = 7.69 Hz voltage on a cap, charging v = v₀[1–e^(–t/τ)] v₀ is the battery voltage v is the voltage after ", 742, "8Y7LQ6TGaa", 0],
	...
	4442 : ["I love these problems. The resistances are R(V1)=48Ω                                  R(v2)=17Ω                                  R(V3)=15Ω                                  Rt=38+42=80Ω                                I=E/R=240/80=3A Now get the drops and p", 744, "a8pRDaIyaa", 1],
	...
	4444 : ["essentially you are correct. If I interpret that drawing correctly, when you get total R, then total I, just use current divider rule to see how the current divides at each junction. Alternatively, (I don't like the current divider rule), calculate the vo", 744, "8Y7LQ6TGaa", 1],
	...
	4450 : ["Not \"experts\" but one guy who is pushing Ivermectin as a drug to treat COVID. Hardly an expert if you read his criticisms of the COVID vaccine he is wrong about most of what he stated. Some of his criticisms can apply to all vaccines and so the guy is clu", 738, "0nyWiro9aa", 2],
