var answers_dict = {
	351 : ["There are people dying every day of something. Did you think that when people are vaccinated for COVID they quit dying of everything.  It's a COVID vaccination,  not a death vaccination. I've had both COVID vaccination shots, and when they have a vaccinat", 59, "BT6qJUhJaa", 0],
	352 : ["Teachers are what is called \"mandated reporters\". By law, it is their duty to report child abuse or child endangerment. If you tell a teacher, as a responsible adult, she or he must act on what you've told them to protect your friend. Several things could", 60, "hYKEgUL5aa", 0],
	...
	357 : ["A clot, moving around in your blood stream, can be fatal if it gets into your Brain (Stroke) .. Heart (Heart Attack) .. Lungs (Pulmonary Embolism) .. or any other major organ. The symptoms of a blood clot in your system would be swelling, redness, tendern", 64, "GXMIMEtQaa", 3],
	358 : ["Yes it can for a short period of time until it heats up to the core temp of the processor after that it does no good. A heat sink has fins to radiate heat to the air and a fan to blow air across the fins. There is a complex calculation to determine the si", 66, "a8pRDaIyaa", 0],
	...
	361 : ["Yes, a ceiling or the entire house can collapse into the basement if the house is a direct hit. The general safety instructions I remember as a kid, when I lived where there were tornadoes, was first the basement, then under a sturdy table. My dad had a m", 68, "dYA8AerXaa", 3],
	...
	364 : ["Not during intercourse. It makes no difference at all to feeling,   By the way, there's also no increase or decrease in pleasure for a woman with one or the other.  Women don't normally come from intercourse anyway. It's what a man can do with his hands a", 69, "swkDtnCjaa", 1],
	365 : ["only when giving oral.............", 69, "None", 2],
	366 : ["Not during intercourse, but yes during oral.", 69, "None", 4],
	367 : ["Because most people aren't in the NFL (?)😕", 70, "LtiG9zv8aa", 2],
	...
	372 : ["No. I trust NO vaccine of any type. I know the basis upon which they work. I'd usually rather take my chances with the disease. But neither is GETTING Covid safe so... .  I didn't want to get the vaccine because I really don't socialize with anybody anywa", 59, "None", 0],
	...
	376 : ["Yes, it is dangerous.  For her height, her weight is in the morbidly obese range. She should lose weight and figure out the cause of her obesity, whether it's too much fast food, sugar, sodas, or salt.  She has to figure out what the bad foods are, why sh", 61, "None", 1],
	...
	381 : ["I learned early on that the bullies are never prepared for the lightning attack. I found that as soon as a bully came up to me trying to start something I'd punch him hard in the 3rd button area of his shirt. When he bends and starts gasping for breath th", 63, "None", 1],
	...
	384 : ["The large block of aluminum is actually a less efficient way to cool the microprocessor.  It has less surface area and that is what is needed to dissipate the heat because, as others have said, you need to eventually transfer the heat to the air. Fins in ", 66, "wJTsifugaa", 1],
	385 : ["yes - but where does that heat go? The block can't heat up indefinitely - it would melt eventually.  It will come to thermal equilibrium with its surroundings which may result in the processor trying to run at a temperature higher than it is rated for.  T", 66, "7uFaB8QQaa", 1],
	...
	397 : ["Anecdotally, I did master the trick by being too depressed to give a ****, and I was still harassed. That whole piece of advice just places the blame onto the victim and makes them take responsibility for the bully's actions. Assuming you're young, you sh", 63, "None", 1],
	...
	400 : ["She certainly is young enough to wait for someone to be brave enough to join her. Therefore, yes, it's very likely she will be the first person to give birth on Mars. I didn't even think it was possible for someone only 20 years old to be so qualified, bu", 67, "E6IgnT59aa", -1],
}