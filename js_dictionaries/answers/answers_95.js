var answers_dict = {
	...
	4754 : ["Tsar Nicolas 2nd was the one who was stopping the antichrist from coming to power. Now, Jews took over churches; it's the end. Apocalypse started because of abortions and mark of the beast documents. Antichrist Jew Lenin legalized abortion in Soviet Union", 810, "None", -1],
	...
	4760 : ["Well, I would describe it one way, and another person would describe it in another way. All that matters here is how YOU do it, and that is every author's challenge: to find the right words all the way through the story.  You're going to be \"stuck\" severa", 813, "OmCctnoQaa", 0],
	...
	4770 : ["No. Canada is too far away from the West Coast of Ireland. Dunmore Head is the westernmost point in Ireland on the Mainland. There is a lighthouse on Dunmore head 276 Feet above Sea Level. At 276 Feet Above Sea Level you can see 20 Miles out to sea. Remem", 798, "dU8aU9wTaa", 0],
	...
	4773 : ["I'm about to take a drive in my Land Rover though the city, chillaxing to some smooth jazz, in my quest to find the best 24 hour diner in all of Chicago.  To Joe, Nancy, Chuck, ANTIFA, Maxine, BLM, \"A\" and Ms. Harris: You all can KMA!! Huge bird finger to", 815, "AA10344136", 1],
	...
	4781 : ["Longitude lines are the vertical lines on a map or globe.  They run from the north pole to the south pole.  0 degrees longitude was arbitrarily set as the line that runs through the Greenwich Observatory in London, and 180 degrees is on the opposite side ", 795, "1pUiedTEaa", 0],
	4782 : ["Latitude changes as you go north and south. Longitude changes as you go east and west.", 795, "YOqbGO2Maa", 1],
	4783 : ["Not only heard of it mate, I've lived in it, had sex there a lot and went to the toilet there quite a few times. It's very sunny mostly, and the beer is pretty good too. Worth a visit, if you can find out where it is and if the locals want to increase the", 749, "zOll9wCMaa", 1],
	...
	4793 : ["I have a relative who works for the Library of Congress. A major part of what he oversees is creating digital copies of works that were not previously available in that format. The machinery to do this has improved enormously in the years he's been doing ", 807, "dYA8AerXaa", 3],
	4794 : ["I'm in another country, and confused. Does the UK library system prevent patrons from borrowing certain books? On what basis (i.e., age, criminal record)? Do they do inter-library loans, so a book one library doesn't own can be lent by one that has it? If", 808, "None", 5],
	4795 : ["I can't think anything when you don't give me something to read. Keep an eye on using capitals correctly. And your character profiles say nothing important about the character just surface stuff. It's more like a casting reference than information about t", 809, "v1JG8C9caa", 2],
	...
	4798 : ["What I do is find a painting of a scene that suits what I'm trying to describe or just use your imagination. List a few describing words. Then look to the 5 senses smell, taste, touch, hearing, smell. Then think about you're character how does it make the", 813, "v1JG8C9caa", 0],
