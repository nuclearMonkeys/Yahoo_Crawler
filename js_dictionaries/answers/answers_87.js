var answers_dict = {
	...
	4356 : ["I had machine contract inside Toyota, Georgetown, KY. I hooked up the wires wrong and burned up the motor power supply. Then I got a free tour ending up at the Electrical Shop using a golf cart. The Toyota electrical shop had all the parts and tools I nee", 719, "rWno7Zqvaa", -1],
	...
	4363 : ["Both. America is 2 continents, South America and.  North America that include Central America. Canada, Mexico and the United States of America are sovereign countries in North America. Canadians and Mexicans are Americans too. Colloquially, \"America\" Usua", 708, "x7kOP9CGaa", 0],
	4364 : ["West to east. The low and high pressure weather systems rotate in the?opposite?directions  The Earth is rotating west to east in the southern hemisphere but the Coriolis forces are east  to west in the temperate zone just like they are in the northern hem", 695, "x7kOP9CGaa", 0],
	4365 : ["Where I live in Australia the main wind comes from the South-East. Being North or South of the Equator has no bearing on the direction the Wind Blows. The Wind can come from any direction no matter where you live. What is Different in the Southern Hemisph", 695, "dU8aU9wTaa", 1],
	4366 : ["The \"Lord of the Rings\" trilogy was shot there. I've actually met a couple of kiwis.  Nice people.  You, on the other hand, are a troll.  I don't think YOU really exist.  Based on a variant of \"I think, therefore I am.\"  For you it is \"You don't think, th", 677, "aj5IBTuXaa", 4],
	...
	4374 : ["I'd see a doctor. I feel your pain, I have to follow all sleep guidelines like force myself into a routine, eliminate all blue light after 9pm, no light sources or stimulations after 10, bedroom only for sleep, take sleep aid, keep notepad for ideas or co", 737, "AA10954511", 1],
	4375 : ["Here is the thing: Deaths from Covid 19 are due to Cytokine storms. Well, the drug companies and universities (that all get tons of money from the drug companies) will not do clinical trials on the easiest likely therapy:  combinations of histamine H1 and", 738, "52Ir0z50aa", 0],
	...
	4380 : ["Yes. In fact: you've hit upon a great method for dealing with such problems. It's common for homework and test problems to have circuits drawn in a non-standard format in an attempt to confuse the student and so redrawing circuits in a format that is fami", 731, "g9g3fOYyaa", 2],
	4381 : ["Yes, that is correct. For a mental shortcut to work out parallel resistances like that, imagine each is in turn made up of a value that is a common multiple of both; eg. six ohms for that example, as a multiple of both 2 and 3. The upper leg (3R) is like ", 731, "T5MR7fNHaa", 1],
	4382 : ["You have to decide what you want it to do. After that you can make up a truth table. Do you want it to stay on until cancelled? Or turned off? Do you want it to stay on for a set time then turn off? If it is to stay on until you do something - then use a ", 733, "GoWoGKyQaa", 0],
	...
	4390 : ["The current is determined by the total resistance, which in this case is the load plus the wire resistance.  unless you are using much too thin a wire, the effect is small. an example, a 15 amp load at 120 volts is 8 Ω now if you have 100 ft of #14 wire t", 715, "8Y7LQ6TGaa", 1],
	...
	4392 : ["The change in resistance is trivial so there is no change in flow.  The wire was not maxed-out before.  If it had been (if the current was limited because of wire resistance), then increasing the cross-sectional area (larger gauge) would allow more flow. ", 715, "WbVE1cXKaa", 1],
	4393 : ["Lancaster...........", 734, "hcOYoOJuaa", 0],
	4394 : ["Lancaster County.  Steam trains too", 734, "yAomXwMVaa", 0],
	4395 : ["No.  There are tasks that humans do better than the robots when it comes to assembly.  So, the assembly line moves to meet production quotas where robots do some of the work and humans do the rest.  Its a very big deal in a manufacturing facility when the", 719, "TosKqL2faa", 2],
	...
	4401 : ["The people that live there know that it exists.  All the Maps I have seen show NZ right were it is supposed to be.   I know exactly where it is, I have been there. Google Maps also has the right location. No Unicorns or Hobbits. That is Hollywood. However", 677, "dU8aU9wTaa", 2],
}