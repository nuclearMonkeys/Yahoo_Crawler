var answers_dict = {
	...
	11705 : ["UNLESS, a claim has been filed, then odds are there will be no history of the car being flooded, nor the title changed.  They could have waited till the water was out, cleaned it up, then sold to an auction with no prior indication of the car being in a f", 1950, "IXtiKaOYaa", 1],
	11706 : ["If you report it, they ask when the flood damage happened.  If you tell the truth and say that it was before you bought the car, then they tell you that it is not covered by your insurance because insurance only covers things that happen after you buy the", 1950, "MmTe8W8uaa", 0],
	11707 : ["I'd do whatever it takes to get rid of it and recoup my money.", 1950, "56f7791c16875200e7c89ce0bbaf53cbaa", 0],
	11708 : ["I mean the question itself sounds like one that someone would answer no to that question but what do you mean by sitting around all day on the couch? Do you mean that you're watching movies together? That you're just relaxing on the couch all day next to ", 1951, "3bbaee26ea87bec4ec7ae86a8c44ff26aa", 0],
	...
	11725 : ["Commenting has been removed. They say it is temporary, but it sounds like changes may be coming based on what kind of user feedback they get. Yahoo's announcement on this can be found at the bottom of every article posted: Our goal is to create a safe and", 1935, "aukIbvHmaa", -3],
	11726 : ["I don't know why they thought it a good idea to eliminate the comments that folks make on other comments, I do know that it wasn't a good idea.  The comments to comments to comments is what made this web site so compelling and a definite go to as you got ", 1935, "3wS629L4aa", 0],
	11727 : ["Commenting has been removed. They say it is temporary, but it sounds like changes may be coming based on what kind of user feedback they get. Yahoo's announcement on this can be found at the bottom of every article posted: Our goal is to create a safe and", 1936, "aukIbvHmaa", 3],
	...
	11731 : ["They don't like when the general public knows more about the story than their team of highly trained, professional leftist hacks. The election isn't going their way either, and the whole Seattle and Portland thing was really biting them on their leftist b", 1947, "B8vnK1ptaa", 10],
	11732 : ["Everyone knows Yahoo is leftist and said bad thing even Trump is so good.", 1947, "AA10485460", 8],
	11733 : ["A few reasons.  A) they think they can influence the election better by not allowing people to point out the ridiculousness and inaccuracies of their liberal propaganda disguised as \"news\" B) They are like immature children who can't take their \"work\" bei", 1947, "1us2DNK2aa", 14],
	...
	11736 : ["No, when you cant debate the facts or the basis of an article, especially the one sided stories found on Yahoo, its pointless to read them at all. Dylan Stableboy was the worst offender in my opinion. I also looked in the comments section for links to the", 1930, "B8vnK1ptaa", 13],
	...
	11741 : ["V6 Altimas are surprisingly quick.  IIRC the circa 2005 models could go 0-60 in the low 6 second range, and a mid-high 14 second quarter mile time.  A new edge GT with the automatic has similar performance with the manual model being a bit quicker with a ", 1966, "7BHIyMFmaa", 0],
	11742 : ["It will all depend on the condition of the specific vehicle in question. Since both are over 10 years old I can guarantee that neither will perform as well as the published specs, which are based on performance when they were brand new. Even when new, the", 1966, "None", 0],
	11743 : ["you really have to ask ?? an Altima ?? really ???", 1966, "None", 0],
	11744 : ["People tend to write very similar to how they speak. As Yahoo was, and Verizon (the company that owns Yahoo now), is based in the U.S., it's not odd to see a lot of that from the folks in the U.S. You'll also see some from other users, from around the wor", 1954, "AA11447210", 1],
	11745 : ["International, but 75% USA, so USA people use what is easily understood.", 1954, "AA10132204", 0],
	11746 : ["Gawd love a duck, mate, why are you getting your knickers in a twist about colloquialisms? It make sense to write so your intended audience can understand. If we choose to target our question or answer, maybe that is a conscious choice. Alternatively, if ", 1954, "gYPV2W02aa", 2],
