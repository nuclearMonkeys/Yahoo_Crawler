var answers_dict = {
	...
	2554 : ["When a pharmaceutical company researches new drugs it takes a long time, costs huge sums of money and only a small percentage of putative medicines that start the process are found to work and make their way into use. A pharmaceutical company makes no inc", 405, "kz04oBhsaa", 0],
	2555 : ["Countries don't manufacture vaccines. Pharma companies do that. They have to recover their outlay and overheads to stay in business. So they won't allow replication without issuing a licence. That's always been true of all vaccine production. No doubt the", 405, "None", 0],
	2556 : ["only advanced places have the ability to mfg", 405, "AHZ7fgQHaa", 1],
	2557 : ["Perhaps the symptoms of a slight slur may either be from having a reaction to the anesthesia or perhaps too much of it.  Someone in a vegetative state may open his or her eyes but still *not* be aware of what's going on in his or her surroundings.  After ", 416, "rSTNUGy3aa", 1],
	...
	2565 : ["AC loads are more accurately modeled as constant watts and vars. Volt Amperes VA = V x I* so if Voltage V decreases, current I increases. I² R losses are very expensive which is why you see 115,230,345 and 500 and even 765kV towers delivering GigaWatts to", 400, "AA12295435", 1],
	...
	2568 : ["A single dose will cause a much higher maximum concentration of the chemical in the blood stream than the same amount spread out over a day.  The main issue with toxicity, like with most things, is mostly one of maximum concentration.  Toxicity does invol", 417, "WbVE1cXKaa", 0],
	2569 : ["The newer guidelines say do not exceed 3,000 mg a day, especially if you use acetaminophen often, 4,000 mg/day (or excessive single doses) are toxic to the liver. This can cause PERMANENT liver damage! AND You should only take 1000mg at a time - this is I", 417, "AA10954511", 1],
	...
	2574 : ["Absolutely help her. Just make sure you know what each medication is for and how to take the medication and how often.  You will have to take most of that burden if you want to call it that. She took care of you as a baby and now the roles are switched bu", 413, "0nyWiro9aa", 1],
	2575 : ["The caretaker isn't permitted to help with the medication because the caretaker doesn't want to be legally liable in case the medication causes complications.  Are you going to sue yourself if you help your mother with her pills and something happens?  Sh", 413, "MQgzLGEwaa", 0],
	...
	2580 : ["The word \"decline\" means a a gradual and continuous loss of strength, numbers, quality, or value. Not sure why that is a word you don't understand. In medicine it means her health is getting worse, the things they measure to determine health are getting w", 415, "None", 2],
	...
	2585 : ["basically, jews,buddhists,muslims pray head down to satan. during the night christian earthlybowdowns count 40 times more than daily earthlybowdowns. since, most of the time witches pray during the night against christians, it's best to pray at night ...m", 419, "None", 0],
	2586 : ["It does all kinds of bad stuff, but no real prolongation of bleeding.  It damages your blood vessels which in the long run increases you risk of heart attacks and the clots breaking off from the vessels to plug up other organs like the kidneys , brain, an", 419, "52Ir0z50aa", 0],
	...
	2594 : ["Unless you're some sort of genius you don't have the time for of those other studies in addition to your engineering school. I happen to have an advanced degree in EE, and I won't give myself as an example, but I was in classes with some very smart studen", 420, "VUdaZUpwaa", 0],
	2595 : ["water finds its own level", 420, "AA11959207", 0],
	2596 : ["You're a liar and a troll.  Go away.   Any engineering student is studying engineering 24 hours a day and 7 days a week.  It 's a miracle any of them even get sleep at night.  Of 100 engineering freshman, only 40 will be juniors.  Of those, 25 will gradua", 420, "None", 0],
