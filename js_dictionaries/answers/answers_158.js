var answers_dict = {
	...
	7910 : ["Possibly because she could see that they weren't real and knew she should call the police to arrest you but didn't want to do that because you were only 13. Or, if she was telling the truth, because they don't want $4000 in cash around, because they are w", 1268, "MmTe8W8uaa", 1],
	...
	7914 : ["It looks like a real ring to me, the stones might be fake but that is not what you asked. There are ways to tell, but to do so at home may involve damaging them, so take it to a professional jeweler. ------------------------------ The fog test: A quick an", 1269, "roiigCk1aa", 1],
	...
	7922 : ["Because Liberals are RICH people who try to convince POOR people that they actually give a **** about them. Notice how they complain about increased taxes on the upper middle class, how they discount EXPENSIVE purchases (Teslas) instead of using that mone", 1270, "None", 0],
	...
	7936 : ["Rolex is greatly-overrated. There are lots of brands that are a lot costlier and better-made. Rolex has 2000 workers who produce 1,000,000 watches each year. That means a worker has only 4 hours to spend on an average watch. Patek Philippe also has 2000 w", 1285, "tuULGJS6aa", 1],
	7937 : ["You contact the subscription number inside the magazine and let them know.  You know those self-addressed, pre-paid postage subscription cards that are always in magazines that end up falling out onto the floor when you flip through it where all you have ", 1271, "NAeE0TtAaa", -1],
	...
	7940 : ["A C should not feel tighter than a B, since C cups are larger than B cups. However, buy whatever works for you.  Don't bother with fitters, just try on a few sizes in the store.  Bras made by different manufacturers (and in different materials) will fit d", 1272, "None", -1],
