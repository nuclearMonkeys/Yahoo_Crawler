var answers_dict = {
	...
	4210 : ["0.60F + 0.35F + 0.35F = 1.30F 1/Ceq = 1/0.72F + 1/1.30F + 1/0.75F Ceq = 0.2864F Qtot = CV = 0.2864F * 100 = 28.64 coulombs Vc1 = 28.64/0.72 = 39.78 volts Vc5 = 28.64/0.75 = 38.19 volts Vc2c3c4 = 28.64/1.30 = 22.03 volts [39.78 + 38.19 + 22.03 = 100, check", 700, "WqRctcQ7aa", 1],
	4211 : [";To find the equivalent capacitance, we should regard C2, C3, and C4 as a parallel combination, whose capacitance is therefore 1.30 F.  Then, the 1.30 F is in series with 0.75 F and also with 0.72 F.  So the equivalent capacitance for the whole circuit is", 700, "Kf4PiubQaa", 0],
	4212 : ["They are calling you an “eh-hole” lol ", 691, "cCsMARcWaa", 1],
	4213 : ["Probably, but use it sparingly since that will accelerate the wearing down of the iron tip.  For general cleaning you should use a wet sponge, and only use the metal scrubber for crud that won't clean off easily.  I bought a couple of those copper Brillo ", 686, "DMOX8xkBaa", 1],
	...
	4216 : ["Yes, smallish wires are OFTEN used for high voltages, such as your ignition in a vehicle, thousands of volts with 16-gauge wires having adequate insulating materials (thickness, breakdown voltage, etc).  As mentioned by others, air (spacing) is also an in", 702, "VjgqZetcaa", 0],
	4217 : ["Yes, If the insulation or spacing are sufficient the wire can handle any voltage but not current. Look at Hi tension lines which run across country. they carry up to 1,000,000 1(MV) but very low current. If they carry 10A at 1MV they are transporting 10MW", 702, "a8pRDaIyaa", 0],
	4218 : ["You'd need to replace the wall receptacle and the wires leading from the wall receptacle  to the junction box. There's no way you can use the present system to carry 40 amps safely. You'll need about AWG #8 I'd guess, but  you should look it up on Google ", 703, "VUdaZUpwaa", 0],
	...
	4220 : ["CCW current is counter intuitive. Assume Clockwise i1 and i2. Switch signs later. Write the equations: -10 because there are 10Ω in loop 1 & 5Ω common with loop 2.   Loop 1 -10i1 +5i2 = -15 so i2 = (2i1 - 3) Loop 2:  +5i1 because 5Ω are common with loop 1", 705, "AA12295435", 0],
	...
	4223 : ["The IEEE publishes a salary survey every year and it is broken down by degree, experience, and locality.  I'd first look at that.  Salaries will vary according to where you reside and work, but I'd have to say the number you quote sounds a bit low at leas", 706, "7uFaB8QQaa", 0],
	4224 : ["Russia is a country. Which continent it's on is only a matter of human definition. There is no geographical division between Europe and Asia within Russia. Culturally speaking Russia would be considered part of Europe (especially the western part where ne", 707, "None", -2],
	...
	4227 : ["There are two continents viz. North America and South Amerrica.  Each continent contains several sovereign nations(countries).  On the continent of North America is the country named United States of America(USA). The USA is often casually named as 'Ameri", 708, "0cc349e5b23bb03a0dcb7d4307ba36b0aa", 1],
	...
	4233 : ["Yes to both. In both the northern and southern hemispheres, the prevailing winds generally blow E->W in the polar and tropical regions (60 to 90 degrees and 0 to 30 degrees latitude, respectively). In between (temperate region), the prevailing winds are w", 695, "DVdX6I4kaa", 0],
	...
	4248 : ["In my area, the primary voltage through the neighborhood is 7500 volts.  It is stepped down to 120-0-120 volts (240 volts centertapped) throughout the neighborhood.  The individual step down transformers are additive.  They DO give the higher current coll", 714, "None", 1],
	4249 : ["If the 14 ga wire is large enough to carry the current then the amperage won't change much. Larger wire is useful in two cases. 1. If there is a very large current. 2. If the run is a very long distance. Look at the wires into any Home. Usually there is 2", 715, "a8pRDaIyaa", 2],
	4250 : ["Your load won't increase. The current won't increase. With the larger conductor size, its voltage drop will be less, so there will be slightly higher voltage at your device.  Depending on the length of your wires, that voltage might only be a few hundredt", 715, "None", 1],
	4251 : ["\"1hp requires how many amps?\" A lot of good answers here already.  But just remember one thing.  HP is an output power rating.  So the measure of 1HP is 746 watts.  But note that it will take more than 746 watts of power input in order to get 1HP output b", 716, "aSm9xSn3aa", 2],
}