var answers_dict = {
	...
	5103 : ["These things are not inherited. People who have a hard time dealing with stress are more prone to depression than others. especially if they have depression in their families. The thing is for you to gain a healthy lifestyle and good coping methods, and t", 847, "oc4ZyRBLaa", 1],
	5104 : ["As far as I am aware all the COVID-19 vaccines require two doses: an initial dose and a booster. The research published by Pfizer-BioNTech produced the advice that the two doses be given three weeks apart. I live in the UK and our government has been givi", 849, "kz04oBhsaa", -1],
	...
	5109 : ["Probably Mars.... it has a day similar to Earth's, so you could charge batteries with solar panels during the day, and use the stored energy over a night that doesn't last very long.  Most of the other bodies we're able to walk on (that excludes the gas g", 852, "FiCIAYGGaa", 0],
	...
	5114 : ["4^(x) - 2 = 3 ? 4^(x) = 5 Ln[4^(x)] = Ln(5) x.Ln(4) = Ln(5) x = Ln(5)/Ln(4) x ≈ 1.16096 x = 1.161 4^(x - 2) = 3 ? Ln[4^(x - 2)] = Ln(3) (x - 2).Ln(4) = Ln(3) x - 2 = Ln(3)/Ln(4) x = 2 + [Ln(3)/Ln(4)] x = [2.Ln(4) + Ln(3)]/Ln(4) x = [Ln(4²) + Ln(3)]/Ln(4) ", 853, "cctjeROnaa", 0],
	...
	5117 : ["No, but either way the cops cannot do anything about it since he did not threaten you. He called you a name, insufficient for an arrest. The cops did not snitch on you, they just told him to stop bothering your neighbor. You could call the non-emergency n", 863, "qpcYYWlIaa", -6],
	...
	5120 : ["If it's 500 vs 600 or something comparable that's fine.  If it's 100 vs 200, that could be a problem.  Power output of an amp varies greatly -- it may be rated for 500w rms, but playing music its actual output would be significantly lower.  That is why ov", 864, "QpsR2jOsaa", 1],
	...
	5123 : ["You want the power to be on to go to another button which is activated when you press it and only when you press it.  As soon as you let go it stops powering the horn.   It is the same thing for the stereo.  It only is on when the stereo is turned on.(mea", 865, "None", -1],
	...
	5127 : ["If you have a concealed carry permit or you live in a state with constitutional carry, you should have it ON you in the car. If you don't, it has to be \"not readily accessible\" and unloaded in those states so it's just a paperweight and you will dead long", 868, "None", 0],
	...
	5130 : ["Of the many passages that gave me pause when I first read “Lady Chatterley's Lover,” in high school, the one I remember the most clearly is this conversation between Connie, Clifford, and the Irish writer Michaelis: “I find I can't marry an Englishwoman, ", 869, "Pwqi7n4uaa", 0],
	...
	5133 : ["No. Interestingly: very many meteorite sites in the Old World were mined for their metal centuries before the Iron Age (that is: centuries before anyone knew what iron was or how to make it). So also: some in the New World. Why? These ancients discovered ", 856, "g9g3fOYyaa", 0],
	...
	5139 : ["What deaths? There has not been “countless” deaths due to the vaccine, only to the virus itself. I have done research, and I think you are wrong.  The virus has cause more damage.  Beside death there are people who are depilated because of contracting the", 859, "None", 4],
	5140 : ["for starters all vaccine can cause side effects , get your facts right , over 50 its recommended but you can choose not to have it , the covid only fatal if you are 65 , and older , any younger than 65 and its know more than a bad flu , even the measel ja", 859, "Be9bOu80aa", 0],
	...
	5145 : ["Thank You Captain Obvious Very few children can read before the age of five.  So why would anyone market books to them?   If a parent is reading to them, they'd pick a book aimed at older children or one with pictures, aimed at teaching them to read. If t", 861, "lMtLhjrcaa", 1],
	...
	5147 : ["If your goal is commercial publication, you do not need an illustrator. The publisher selects an illustrator whose style matches the text, and the author rarely (or never?) gets to approve or reject that illustrator. If your plan is self-publication, you ", 861, "dYA8AerXaa", 4],
