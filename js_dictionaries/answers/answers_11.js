var answers_dict = {
	...
	552 : ["I predict London is 30% White British, perhaps around 40% White overall if you include the Irish, continental Europeans, Russians, American/Aussie/Canadian expats, etc. Birmingham and other cities probably similar. The country overall will be about 75% Wh", 76, "None", -2],
	...
	556 : ["It DEPENDS on your SKILL level and the WAY the STICK SHIFT is designed and carried out! AN OLDPORSCHE is a VERYHARD gtruck like clutch< for example! The SAAB is VERY eaSy and is HYDRAULIC! Many older cars use OUTDATED technology, too! The HARDEST part tol", 103, "HFrsH9MRaa", 0],
	...
	567 : ["They are a bargain for the performance and the driving experience that you get.  They are only \"terrible\" because it is really not a luxury car but an inexpensive sports car.  It is not a Mercedes but it will outrun most Mercedes, in the street or in a tr", 92, "None", 2],
	...
	569 : ["It is impossible for a Semi Truck to pass on a one lane road.  (see below.) One a one lane road you are legally required to pull out to allow people to pass, If there is a dotted line, it is a TWO lane road. If you are not capable of keeping up with traff", 94, "Pa7wl1Bnaa", 0],
	...
	573 : ["You can probably go to Walmart and pick out a pair of regular frames and get clear lenses in them. Assuming that you think that you have good eyesight, have you ever had an eye exam? Many people go in to get their eyes checked thinking they can see good a", 102, "None", 1],
	...
	577 : ["A book of 1000 pages is at least twice as long as most novels.  Ask the person who told you to read two books a month (your teacher?) for the number of *pages* or *words* in his or her estimation of an average \"book\". There is a big difference between \"pa", 89, "AA11768465", 2],
	...
	580 : ["You do not want any air in the fluid. There is a membrane in the master cylinder that expands and contracts as you apply the brakes, that is what gives you \"feel\" at the lever and that relies on an amount of air but it is not air in the fluid. I suspect y", 84, "None", 0],
	581 : ["Caliper is likely shot.  Check if pistons are retracting completely when brake lever is released.  If they are not, clean pistons or replace them, clean piston cavity and install new seals.  Or just replace the caliper. You can try bleeding the master cyl", 84, "None", 2],
	582 : ["You do not want air back in the cylinder.  Did you make sure to top off your reservoir when you bled them?  If they are full, it sounds like a caliper issue.  The first question you should ask though is how you got air in the system to being with.  That s", 84, "MhZ0hg1gaa", 1],
	...
	584 : ["I love driving a standard but neither one of our vehicles where made with one or at least in the USA. My wife don't know how to drive one and is not willing to learn either. If she did my vehicle would be a Toyota Tacoma with a stick shift at least becaus", 105, "None", 1],
	...
	587 : ["No such thing as self serve.  They also had free air. As their garage mechanics used air tools. Most could change a tire off rim and other on. Wheel balancing machines were more like a flat roulette wheel and they weighted the tire non rotating. They had ", 107, "None", 0],
	...
	591 : ["It requires good hand, eye, foot coordination. Practice shifting with the engine off. Get a feel for the gear locations. Have an experienced driver show you. Once you hear how the engine revs you will know when its time to shift up and watch your speed. P", 103, "95oRMAQjaa", 2],
