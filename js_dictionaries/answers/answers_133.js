var answers_dict = {
	...
	6653 : ["Well I think those are called centaurs and they have been around for 4 maybe 5 thousand years, then there is the Minotaur that's bull and human PAN was a goat / human and there are MANY others you just have to be careful who and what you sleep with becaus", 1084, "loYZjepjaa", 0],
	...
	6659 : ["What are the medical advantages of getting thinner? In case you're overweight or fat, getting in shape can diminish your danger of some conceivably genuine medical issues. The vast majority who need to get thinner can get medical advantages from losing ev", 1079, "FQzq4w73aa", -1],
	...
	6661 : ["g(x) = 4x² - 2x + 15 Find the first derivative of this function, which will give you a function: g'(x) = 8x - 2 Now substitute 5 in for x and simplify: g'(5) = 8(5) - 2 g'(5) = 40 - 2 g'(5) = 38 If you look at the original curve at x = 5, that section wil", 1085, "DU8zxsKRaa", 0],
	...
	6663 : ["g(x) = 4x^2 - 2x + 15 so, cheating temporarily g'(x) = 8x - 2 and g'(5) = 8*5 – 2 = 38 You want use limits so here are some helpful bits you can include. g(x + h) = 4(x + h)^2 – 2(x + h) + 15 ... (you expand that) g(x) = 4x^2 - 2x + 15 g(x + h) – g(x) = 8", 1085, "5DXcWNiCaa", -1],
	...
	6667 : ["I would expect the US's economy to stabilize after the vaccines start coming out. US economy has collapsed a lot but has shown an ability to recover, largely because of its position as the world's reserve currency, it can just keep printing money to buy i", 1069, "oQtPhaQVaa", 1],
	...
	6670 : ["If you keep asking that would help. It is not  dark enough, there is not enough color.  That is a sexy eyeball.  You want to be able to attract attention to it from further away.  Makeup is an accessory, you need to use it to really call attention to spec", 1073, "PhIiWTpbaa", 1],
	...
	6676 : ["\"If the equality act is passed, will it overturn all the feminist won laws advantaging women?\" Not necessarily. The equality act is an amendment to the Civil Rights Act that gives transgenders equality to their opposite sex (and stated gender). And it's d", 1091, "aSm9xSn3aa", 3],
	6677 : ["It makes me furious and annoys me so badly!! Not only is it unfair but highly misogynistic and what's even worse is how society is okay with it!! Fvck sexist doublestandards!! 🖕🏻", 1092, "None", 1],
	6678 : ["\"For the women out there, how do you feel about the word slut?\" What's missing in this entire discussion is how slvt shaming began as female on female behaviour and is still mostly perpetrated this way, to this very day.  There are far fewer men that try ", 1092, "aSm9xSn3aa", 4],
	6679 : ["There are stories that simply must be told.   And so many of them are long, and must be told at full length. Example;  pretty much every one here knows that I am a docent (guide) at a historic  cemetery. One of my favorite stories is of a scholar who inve", 1093, "xkHtn1FEaa", 0],
	...
	6693 : ["Hi my lovely, I think this is such a good job for a starter! But when you put eyeliner on next time to do this look don't smudge it okay and make sure to use a pen eyeliner (they are so much better and easier to use). If it happens to look like this next ", 1073, "zOZFKkGvaa", 0],
	...
	6697 : ["I never understood the language of Shakespear that was taught at my old high school. The people from that time did not speak in iambic pentameter so why would I need to learn it because of the famous Bard? I am a big fan of Charles Dickens' and Mark Twain", 1096, "6p2nIFM5aa", 0],
	6698 : ["I don't read so idk", 1097, "GWatfe8Faa", -3],
	6699 : ["I will continue to reference if there's ever an instance when I need to lookup the following: Who the biggest troll was. Whether someone's son is gay What ladies think the best part of a man's body is Why people are so confused about their genders Why men", 1098, "None", 0],
	6700 : ["It's too nice......", 1099, "Wj3ZEToZaa", 0],
	6701 : ["We don't need gender specific toilets.  On the Great Vic Bike ride we abandoned that idea ten years ago.  Which makes better utilization of a limited resource at various times.  Most new facilities are not gender specific except at very high demand locati", 1090, "Y1NTL6p2aa", -1],
}