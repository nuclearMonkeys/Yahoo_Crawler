var answers_dict = {
	14961 : ["Isn't there a counselor at your school? You should have been told to have your parents fill out the FAFSA form in the fall. That gets analyzed, and the results sent to the colleges you apply to. Then they make you a financial aid offer. What you need to d", 2515, "cbMTODDZaa", 1],
	...
	14965 : ["After careful consideration of the evidence and the arguments.......... I conclude JWs are simple people who live in a kind of delusional brotherhood of reality (fake). I guess I like truth, living in the real world and thinking for myself.... which means", 2501, "rzt7Vu0Taa", 2],
	...
	14969 : ["It wouldn't be illegal, but you really have no right to ask. Your brother would have to either be chosen or would need to apply and go through the proper procedures, the same as you need to do. They aren't just going to hand a scholarship out over the cou", 2507, "HE8XSehhaa", 1],
	...
	14979 : ["The ordinary public has been seeing and trying to record these things long before. We may get better close-ups from the military, as they have better technology : though our authorities will still be trying to remain in control of the situation ; and hide", 2538, "2ifr1sIRaa", 2],
	...
	14983 : ["Yes. It's easier on the conscious to play the victim than it is to be the aggressor taking advantage of others. When women compete for male approval, women are oppressed. When men compete for female approval however, it's an \"equal\" society, despite there", 2540, "wr1brXE4aa", 1],
	...
	14989 : ["If somebody does not do that for young children, getting them to observe the norms of good behaviour, to learn how to get along with other children and other people, then it is more likely that the youngsters will 'go off the rails' later, end up in court", 2527, "None", 0],
	...
	14999 : ["I think they mean possible rational zeros, and  want you to use the rule that if b/a is a zero, then b is a factor of the leading coefficient while a is a factor of the constant term.  The factors of 35 are (plus or minus) 35, 7, 5 and 1 while the factors", 2531, "AA10439008", 1],
	...
	15001 : ["You can try all positive and negative factors of 35 to find possible INTEGER zeroes. I'd start with the smallest ones (±1, then ±5 ...) because they're easier. But until you find one there's no guarantee that there are any integer solutions. You should ju", 2531, "BxFDTvcLaa", 1],
