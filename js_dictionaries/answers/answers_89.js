var answers_dict = {
	...
	4453 : ["Most motion detectors have a built-in override: Normally the switch is kept on all the time. ... If you turn the switch off and on within a second or so, the light will stay on, and this overrides motion detection. To go back to normal operation, turn the", 733, "JAKVhrHRaa", 0],
	4454 : ["Instead of turning on the LED you turn on a latching relay and use the relay to turn on the LED. You would also need to add a momentary switch to reset the relay when the LED is on in the light and you want to reinitialise the circuit.  You could do this ", 733, "jB2Z6uxhaa", 0],
	...
	4462 : ["If you want to count them go ahead. This is how I would do it. Find the volume of the atmosphere. Do a search for it. The information will be out there somewhere. We all inhale different volumes of air. For example, a man 2 m tall is going to inhale far m", 752, "kz04oBhsaa", 0],
	...
	4465 : ["They're a lot like other places.  Their local economies tend to rely more on tourism than larger countries', since people go out of their way to visit those little countries (we visited Liechtenstein on our honeymoon for that reason), and they don't have ", 755, "P8dIznazaa", 0],
	4466 : ["I am sure that residents of Andorra, Luxembourg, and Liechtenstein look at Google Maps images of typical US suburb, with its identical homes they think it looks soulless.   Ever heard of company called Hilti?  Go to your local Home Depot or Grainger and y", 755, "VO8Xjz0waa", 0],
	...
	4474 : ["First, dry the components. Sticking the components in a hot car for a day dries things quickly. If power was on when the craft sank, you could have electrolytic corrosion on the pcb & motor. On the pcb, look for frosty areas. Clean the area with Isopropyl", 746, "HFuI8oVYaa", 0],
	4475 : ["1. First let it fully dry. Make sure it is bone dry before you try anything. 2. Plug it into a power source first. If you have one, hook an ammeter in series to check the current looks right (should not be more than a few 100 mA). 3. If it's stable after ", 746, "Qa0902C0aa", 1],
	...
	4483 : ["'Struth Mate!!!! Yeah!!! I have. It full of snakes , that bite and yer dead!!!  Also 'Salties' (SAlt Water Crocodiles too) They bite and yer dead too !!!  Try also kangaroos, wallabies, koala bears, duck billed platypus.  Yer want to go there and experien", 749, "0cc349e5b23bb03a0dcb7d4307ba36b0aa", 0],
	...
	4491 : ["Only time will tell what the long term effects of the vaccines are. Short term, they save lives and are allowing some to get back to normal. That is all we have to go on right now due to the nature of the pandemic. I am not eligible yet but when I am, I w", 738, "SnQvsOPwaa", -1],
	4492 : ["Looking at a MAP of Minneapolis, it is the Mississippi River that flows through the center of the City and looking at a MAP of New Orleans it is also the Mississippi River (same river). So, Yes. The Mississippi River is very long. I guess you did not pass", 750, "dU8aU9wTaa", 0],
	4493 : ["You can get from one place to the other on water just floating along on the current, if that is the question (if you drop a log into the river up in Minneapolis, it will eventually make it to New Orleans if nothing stops it).  Naming is arbitrary.  It is ", 750, "WbVE1cXKaa", 0],
	...
	4496 : ["If I understand correctly, you want a light to automatically switch on when it is dark, and switch off when it is no longer dark. And you are wondering how to prevent the light to switch off as soon as it has switched on, since when the light is on, it is", 733, "d3cd3e0f2e8feaaff79363574632bf96aa", 0],
	...
	4499 : ["Vaers data represents opt in reporting, aka a choice. it only represents less then 1% of total potential data. So those reports are less then 1% of total adverse effects and deaths. Let the idiots poison themselves. They will regret it within 5 years time", 763, "aaaffa1132af01d0b83648c1ab86b94daa", 0],
