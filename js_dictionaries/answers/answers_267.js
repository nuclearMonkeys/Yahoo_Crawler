var answers_dict = {
	...
	13361 : ["Honestly I'm wondering the same thing about me, I never get complements but on the rare occasion I do its usually by people who are my close friends. I personally have just learned that confidence is key and can turn any person from a 2 to a 10 [even if i", 2227, "X0Oo54RRaa", 0],
	...
	13366 : ["Well, it was because Nintendo had a partnership with Japanese giant mobile company, DeNA, where both companies tries to develop cross-platfofm service, across PC, Smartphone, and Nintendo's consoles. Due to this, Nintendo decides to remove the native voic", 2236, "EBeItD4Jaa", 0],
	13367 : ["Because Nintendo seems to have built the Switch almost exclusively as a machine made for gaming and has left all of the other stuff out or relegated it to the mobile app. I don't think they've said exactly why but I'm guessing it was because they wanted t", 2236, "ASCIOsbwaa", 0],
	13368 : ["Viruses?  Let's see.  Influenza is different every year is a virus, a Cold is a virus(no, we have no cure for it yet) . They think that Cancer may be a virus too. . There may be some others but they do not come to mind at this present moment. Viruses are ", 2237, "None", 0],
	13369 : ["I will add, why. Viruses are not alive as we know it, so antibiotics which interfere with the life cycle of bacteria have nothing to work on. They simple invade the host cell, and inject their own nucleic acid to make the cell produce more virus. You cant", 2237, "Sozc3MyFaa", 2],
	13370 : ["they would be illegal in most places that car wouldn't have a hope in hell of making it up my driveway. They are a muppet idea that are for looks only . be a lot of narrow driveways that pos couldn't drive on. A hilux would still push that pos off the roa", 2231, "5wJHtJ82aa", 1],
	...
	13376 : ["This answer is going to be in a very simple format. You're going to be surprised when you learn the simple formula that will cut your weight 20 pounds in one month. Just for a reference, this image above is a 20-pound weight loss transformation You aren't", 2238, "JEHxSHNiaa", 0],
	...
	13380 : ["A restrike is a coin struck, using the original dies, at a later time.  So, yes, it would mean the original was produced in the 16th century and the same dies were used in the 19th century. However, you should never rely JUST on what a seller claims. You ", 2235, "2dfe1a04cbba62e3fc3fa1e11c8562e9aa", 1],
	...
	13398 : ["Generally, your whole immune system improves and you feel significantly better. One common problem of most people who struggle with weight loss is due to emotional eating, especially eating sugary foods whenever we feel down. We always hear about these so", 2238, "AQLIy01Laa", 1],
