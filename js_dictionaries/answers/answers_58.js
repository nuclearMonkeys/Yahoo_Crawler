var answers_dict = {
	...
	2904 : ["I suspect a troll. Though possibly your best friend is American (i.e. from the USA) and thus suffering from that cloud of ignorance which covers so many Americans. You do not even need to drive to Canada, simply get hold of a world atlas and look for 'Nor", 476, "None", -2],
	...
	2909 : ["I quote: Cyprus is both an Asian and European country depending on how one looks at it. By its political inclinations and membership in the European Union, Cyprus is a European country. However, it is an Asian country as per its geographical placement. Th", 464, "g9g3fOYyaa", 2],
	...
	2912 : ["In general Americans think that since  the world revolves around them they have no need to learn about the world.  In addition, if you watch American news most of the content is domestic news and maybe one item  is foreign news. Even their TV weather maps", 465, "6Whuc4WXaa", -2],
	2913 : ["", 477, "WzpcZtCHaa", 0],
	2914 : ["Dark Blue States: And electoral votes  Vermont 3 California 55 Washington 10 Massachusetts 11 Maryland 10 Hawaii 4 Oregon 7 New York 29 Rhode Island 4 Illinois 20 Connecticut 7 New Jersey 14 Delaware 3 Violet Blue States:  Minnesota 10 New Hampshire 4 Col", 477, "ejoQezrBaa", 0],
	...
	2918 : ["I expect three possibilities: Argentina Brazil Chile Argentina - northernmost point 21 S - southernmost point 55 S (island), 52 S (mainland) - total: 34, 31 mainland only Brazil - northernmost point 5 N - southernmost point 33 S - total: 38 Chile - northe", 478, "g9g3fOYyaa", 0],
	2919 : ["No.  There are several instances where an island is not \"just an island\". There are large masses of vegetation in lakes and rivers where the surface seems like an island, but is a floating body that moves around.  Many in the delta of the Nile River chang", 479, "2yFSkim8aa", 2],
	...
	2922 : ["My thoughts are that you should not use bad language, even if asterisked, in a serious question. Does the 'f' word reinforce your question? No. And did you really have no idea  before you thought of moving to Alaska how far away from everywhere else Alask", 482, "None", 0],
	2923 : ["its new york city", 483, "hdqdmnjvaa", -5],
	2924 : ["Accra is the capital", 483, "Vtlen7Wcaa", 3],
	2925 : ["Virginia is definately the closest state to the United States Capitol. The border is just the other side of the Potomac River just 3 miles to where the Pentagon Building is. and Maryland is the next closest state to the United States Capitol building. Tux", 484, "None", 1],
	...
	2930 : ["It would help to answer your question is it were more precise. You do not say whether you mean a continent, North America or South America, or the country, the United States of America. Further, state can mean a country, e.g. Canada is a state. Alternativ", 467, "None", 2],
	2931 : ["You need to keep in mind that the United States has grown in size over time, so what was once the Midwest is more cultural than geographical.  Technically speaking Oklahoma is in the South Central portion of the United States, but culturally it is in the ", 468, "None", 2],
	...
	2942 : ["Form my perspective in Britain, any part of the world which does not directly face the ocean is landlocked. Thus Illinois is landlocked. I know that the Great Lakes are very large bodies of water, and in fact I crossed Lake Superior and Lake Huron in 1956", 475, "None", -3],
	2943 : ["The Great Lakes are all connected to one another and are connected to the Atlantic Ocean by the Saint Lawrence River, so technically no state that touches any of the Great Lakes is landlocked. Michigan is ranked as having several thousand miles of coastli", 475, "None", 5],
	...
	2947 : ["At the age of 5 or 6 I knew all the countries of the world as they were in the early 1950s, because I had the use of a world atlas and I was interested in that sort of thing. I certainly knew that Brazil was a huge country in South America. Then I had to ", 463, "None", 1],
