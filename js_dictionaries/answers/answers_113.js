var answers_dict = {
	...
	5653 : ["For the metal it is at a frozen temperature. Different substances have different temperatures at which they melt or freeze. I suspect you may be in the USA. Most people on here seem to be. As far as I am aware you still use the Fahrenheit scale for temper", 940, "kz04oBhsaa", 0],
	5654 : ["Two ways of looking at this: don't call it frozen if you consider freezing to be only a function of temperature (another way to express lack of heat), or consider that \"freezing\" is object-specific so the temperature of freezing depends on the object (fre", 940, "WbVE1cXKaa", 0],
	...
	5656 : ["No need to post this same question multiple times. Giving someone money so you \"don't lose what you have\" doesn't work, you don't have anything but someone willing to freeload off you.You are not a loser, just a teenager still trying to figure things out.", 932, "cyIPEOLYaa", 0],
	5657 : ["Anyone who uses a person just to get money isn't really your friend.  The next time he asks for money, just say \"no\" and move on.  Confide in a teacher, school counselor or nurse or some other trusted adult.  They may be able to help you get through to yo", 932, "None", 0],
	...
	5663 : ["The vaccines all provide above 95% immunity. The Pfizer vaccine, for example, provides 96% immunity. That is assuming you're not immunocompromised, like because you have lupus, cancer, HIV, or some disease that compromises your immune system. So, for me, ", 935, "None", 2],
	5664 : ["No..................", 928, "None", 0],
	...
	5671 : ["Having a pre existing condition is one reason some people die from Covid-19.  However, determining the official cause of death would be the final thing that made him die.  No matter how weak or sick a person is, if they likely would have lived a little lo", 936, "PM7KcE4caa", 0],
	5672 : ["You have a lot to learn. Testosterone does not make your voice deeper. If you were born a female, you have the voice box of a female. That's not going to change. Particularly at your age. As for body hair, you may or may not grow much body hair. I am a 47", 931, "knmkhWIiaa", 1],
	...
	5683 : ["Subtract the two eq'ns to eliminate 'y'  Hence  0 = 28x^2 + 5x -12  Apply the Quadratic eq'n  x = {- 5 +/- sqrt[(5)^2 - 4(28)(-12)]} / 2(28) x = { - 5 +/- sqrt[25 + 1344]} / 56 x = { - 5 +/- sqrt[1369]} / 56  x = { - 5 +/- 37}/56  x = -42/56 = - 3/4(a) & ", 944, "0cc349e5b23bb03a0dcb7d4307ba36b0aa", 0],
	...
	5689 : ["I am an oldtimer in astronomy, having learned to read from astronomy books and other science books about six decades ago. I thought I knew it all, but being on this site has shown me that the most important thing to understand about astronomy, and also th", 939, "bXMPytYEaa", 1],
	...
	5692 : ["You're sooo young! Focus on what you have and what you can control! Try joining a club and finding like minded people to hang with. Ditch the loser who is asking for money. If not giving that person money means they won't hang out then they were not actua", 932, "Gkgbm3XEaa", 1],
	5693 : ["What we can barely  see, is our getting older ....", 942, "None", 0],
	5694 : ["Time only goes faster or slower for us relative to the rest of the universe. That's a very important aspect of this. We still experiece time at the same rate, it just may not be at the same rate as everywhere/everything else. But no, time cannot elapse ba", 942, "None", 1],
	...
	5700 : ["Your premise is wrong to begin with. Your saying that SK's \"novels and stories are ALWAYS scary, dark, creepy, intense, traumatic, heavy, and twisted\" shows that you haven't read that much King, certainly not in the past twenty (or even thirty) years. He'", 920, "fgRkfYcoaa", 1],
